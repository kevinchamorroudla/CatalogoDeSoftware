...
@NamedQueries({
    ...
    @NamedQuery(name = "EquipoFisico.findByFabricante", query = "SELECT e FROM EquipoFisico e WHERE e.fabricante = :fabricante"),
...
public class EquipoFisico implements Serializable {
    ...
    public EquipoFisico(Integer idEquipoFisico, String modelo, String fabricante, String energia, String disco) {
        this.idEquipoFisico = idEquipoFisico;
        this.modelo = modelo;
